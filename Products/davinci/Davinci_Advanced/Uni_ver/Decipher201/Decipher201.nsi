...
OutFile "Setup.exe"
InstallDir "$PROGRAMFILES\FRONTLINE\僨僒僀僼傽乕201"
...
Section "MainSection" SEC01
  ...
  File "..\Rel\zlib.dll"
  CreateDirectory "$SMPROGRAMS\僨僒僀僼傽乕201"
  CreateShortCut "$SMPROGRAMS\僨僒僀僼傽乕201\僨僒僀僼傽乕201.lnk" "$INSTDIR\FileDecrypt.exe"
