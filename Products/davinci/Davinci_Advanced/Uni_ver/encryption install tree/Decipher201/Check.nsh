...
;!macroend
  ...
  IntCmpU $8 1 goodreg
   !insertmacro serial
    ...
    quit
goodreg:*/
  ReadRegStr $0 ${PRODUCT_UNINST_ROOT_KEY} "Software\Microsoft\Windows\CurrentVersion\Uninstall\Decipher101" "UninstallString"
  ReadRegStr $1 ${PRODUCT_UNINST_ROOT_KEY} "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "UninstallString"
  ;StrCpy $R1 $R0
  StrCmp $0 "" YES NO
  NO:
