...
enum MBR_PARTITION_TYPE {
	...
	MBR_PT_PARTITION_HIDE_FAT_16 = 0x14,
	MBR_PT_PARTITION_FAT32 = 0x0B,
	MBR_PT_PARTITION_HIDE_FAT32 = 0x1B,
	MBR_PT_PARTITION_NTFS = 0x07,
	MBR_PT_PARTITION_HIDE_NTFS = 0x17,
	MBR_PT_PARTITION_LINX_SWAP	=	0x82,
	MBR_PT_PARTITION_LINX_EXT	=	0x83
};
typedef struct
{
	BYTE	Jump[3];
