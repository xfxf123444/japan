...
bool PanamaValidate()
{
	...
	pass = HashModuleTest(PanamaHash<false>(), testSet1, sizeof(testSet1)/sizeof(testSet1[0])) && pass;

	cout << "\nPanama Hash Function (big endian) validation suite running...\n\n";
	pass = HashModuleTest(PanamaHash<true>(), testSet2, sizeof(testSet2)/sizeof(testSet2[0])) && pass;
