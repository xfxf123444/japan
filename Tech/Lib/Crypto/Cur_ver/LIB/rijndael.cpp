...
const ULONG rco_tab[10] = {1, 2, 4, 8, 16, 32, 64, 128, 27, 54};

const ULONG ft_tab[4][256] = {
...
Rijndael::Rijndael(const UCHAR *userKey, unsigned int keylen)
{
	...
	k_len = keylen/4;
	GetUserKeyLittleEndian(key, k_len, userKey, keylen);
